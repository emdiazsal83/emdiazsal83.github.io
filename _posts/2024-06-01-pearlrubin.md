...
In the Functional Causal Model (FCM) framework of causality  <d-cite key="pearl2009causality"></d-cite> a system is described in
...
The potential outcomes framework (PO) <d-cite key="rubin1974estimating"></d-cite> provides a different viewpoint of the
